...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonButton, IonImg, CommonModule, IonTabs, IonTabBar, IonLabel, IonTabButton, IonRouterLink, IonRouterOutlet, RouterLink]
})
